...
func init() {
	...
	flag.StringVar(&cosUrl, "cosurl", "", "ossUrl")
	flag.StringVar(&secretID, "secret", "", "ossSecretID")
	flag.StringVar(&secretKey, "secretkey", "", "ossSecretKey")
	//
	flag.StringVar(&locaFilename, "filepath", "/dumps/oom", "maybe the filename is 'dumps/oom'?")
